    ...
    <a href={detailUrl} className="pointer group fade-in-500">
      <article className={['rounded-xl border-1 border-ink-900 overflow-hidden shadow--card', dimmed ? 'opacity-50' : '', 'transition-opacity duration-150'].join(' ')}>
        <div className="rounded-sm">
          <div className="flex flex-col justify-center bg-sand-100 group-hover:bg-sand-050/50 border-b-1 border-ink-900 px-3 pt-3 pb-3 gap-1 rounded-t-lg relative group-hover:shadow-lg group-hover:text-prussian-500 transition-colors duration-700 ease-out">
            <TextStyle
              variant="h3"
              element="h4"
            ...
            <div className="flex flex-row py-1">
              <TextStyle variant="paragraph" element="p" className="max-w-[calc(100%)] text-nowrap overflow-hidden leading-none text-ellipsis ">
                {infoText}
              </TextStyle>
            </div>
          </div>
          ...
          <div className="relative bg-sand-050 overflow-hidden">
            <img
              ...
              height={400}
              loading="lazy"
              className="w-full object-cover aspect-[3/2] transition duration-300 ease-out group-hover:opacity-80"
            />
            <div className="absolute bottom-2 right-2 left-2 flex gap-1 justify-between items-end">
              ...
              {dogsAllowed && (
                <TextStyle
                  variant="caption"
                  element="span"
                  className="bg-sand-200/80 backdrop-blur-sm text-ink-900  max-w-[calc(33%)] whitespace-nowrap overflow-hidden text-ellipsis px-2 py-1 rounded-sm"
                >
